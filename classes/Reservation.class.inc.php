...
class Reservation {
     ...
     * @return int
     */
	public function create($deviceId, $userId, $start, $stop, $description, $training) {
	 ...
	 * @return string
	 */
	public static function getEventsInRangeJSON($db,$start, $end, $userId, $deviceId, $training) { // TODO this might be too specific for this class, and should be in calendar_api
		$eventsArr = array();
