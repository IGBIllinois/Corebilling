...
<form name="verifyForm" method="post" action="instrument_billing.php" class="form-inline">
	<div class="well">
		...
		<div class="form-group">
			...
			<select id="groupfilter" class="form-control" onchange="matchCol(<?php echo "Rate".$rateTypeSelected; ?>,15,'groupfilter')">
				<option value="">All</option>
				<?php
		...
		?>
			<div class="row">
				...
				echo VisualizeData::ListSessionsTableHiddenCols($monthlyUsage,
					...
					array('NetId', 'Name', 'Date', 'CFOP', 'Inst.', 'Elapsed', 'Start', 'End', 'Min. Hrs', '$/h', 'Rate', 'Total', 'Group', 'Department'), "Rate".$rateTypeSelected, true, false, 'start');
				?>
			</div>
